...
import {
  createGame, tick, onDown, onMove, onUp, retry, isSteppingPhase,
  PHASE, inkUsed, inkMax,
} from './game.js';
import { A1, assertLevel } from './levels.js';
...
function render() {
  ...
  if (g.phase === PHASE.RESULT) drawBanner(ctx, 'NAILED IT.', 'tap for another go', 0.44);
...
globalThis.__byc = { game, view, PHASE, retry };
